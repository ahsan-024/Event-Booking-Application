...
<body class="min-h-screen flex" style="background:#F7F8F0;">
    ...
    <div class="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden" style="background:#355872;">
        ...
        <div class="relative z-10">
            ...
            <div class="flex flex-col gap-4">
                @foreach(['Instant booking confirmation','Secure seat reservation','Easy cancellation anytime'] as $feat)
                <div class="flex items-center gap-3" style="color:#c8dff0;">
                    <div class="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style="background:rgba(122,170,206,.3);">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div class="w-full max-w-md">
            ...
            <h1 class="text-3xl font-bold mb-2" style="color:#1a2e3d;">Welcome back</h1>
            <p class="text-sm mb-8" style="color:#6b8fa8;">Sign in to your account to continue</p>

            @if($errors->any())
                <div class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm mb-6" style="background:#fde8e8;border:1px solid #f5b8b8;color:#7f1d1d;">
            ...
            <form method="POST" action="{{ route('web.login') }}" class="space-y-5">
                ...
                <button type="submit"
                    style="width:100%;background:#355872;color:#fff;font-weight:600;border-radius:.75rem;padding:.875rem;font-size:.9375rem;border:none;cursor:pointer;box-shadow:0 4px 14px rgba(53,88,114,.3);transition:background .15s;"
            ...
            <p class="text-center text-sm mt-6" style="color:#6b8fa8;">
                ...
                <a href="{{ route('web.register') }}" class="font-semibold hover:underline" style="color:#355872;">Create one free</a>
            </p>
        </div>
    </div>
</body>
